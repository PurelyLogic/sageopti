      ...
      <section className="py-32 px-6 relative">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 mb-20">
            {/* Free Plan */}
            <div className="reveal-section glass-panel-brand p-8 relative" style={{animationDelay: '0.1s'}}>
            ...
            {/* SAGE Pro */}
            <div className="reveal-section glass-panel-brand p-8 relative" style={{animationDelay: '0.2s'}}>
              <div className="text-center">
            ...
            {/* SAGE GEO - Recommended */}
            <div className="reveal-section relative" style={{animationDelay: '0.3s'}}>
              <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-[#0A3D62] to-[#00BFB3] text-white px-4 py-1 rounded-full text-xs font-bold">
                RECOMMENDED
              </div>
              <div className="glass-panel-brand p-8 border-2 border-[#00BFB3] shadow-lg shadow-[#00BFB3]/20">
                <div className="text-center">
            ...
            {/* Agency Plan */}
            <div className="reveal-section glass-panel-brand p-8 relative" style={{animationDelay: '0.4s'}}>
              <div className="text-center">
          ...
          <div className="reveal-section" style={{animationDelay: '0.6s'}}>
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="border-b border-[#00BFB3]/20">
                    ...
                    <th className="text-center py-6 px-6 font-semibold">SAGE Pro</th>
            ...
            <div className="lg:hidden space-y-6">
              {['Free', 'SAGE Pro', 'SAGE GEO', 'Agency'].map((plan, idx) => (
                <div key={plan} className={`glass-panel-brand p-6 ${plan === 'SAGE GEO' ? 'border-2 border-[#00BFB3]' : ''}`}>
